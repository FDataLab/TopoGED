"""Taken from https://github.com/twitter-research/tgn/blob/master/modules/embedding_module.py"""
...
# Edited import path
from GraphGeneration.encoders.TGN.model.temporal_attention import TemporalAttentionLayer
