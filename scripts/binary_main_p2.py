...
csv_file_path = os.path.abspath('data/output/results/BinaryTesting/data/embedding_testing_second.csv')
...
# Grid search params
datasets = ['networkaragon', 'networkbancor', 'networkcentra', 'mathoverflow', 'Reddit_B']
    ...
    for activation, activation_name in zip(activations, activation_names):
        ...
        for norm in norm_status:
            if norm:
                ...
                X_train_scaled, X_val_scaled, X_test_scaled = X_train, X_val, X_test  # Nothing changes for the data
                
            # This keeps code brief, X_{}_scaled is either normalized or not
