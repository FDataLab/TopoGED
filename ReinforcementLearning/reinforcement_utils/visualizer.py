...
class GraphVisualizer:
    output_path = '../output/reconstruction/'  # The output path for all animations
    
    def __init__(self, reconstruction_states: list, target_graphs: list):
        self.reconstruction_states = reconstruction_states  # Save the graphs constructed over time
        self.target_graphs = target_graphs  # Save the comparison graphs
        self.pos = None
    ...
    def update(self, frame):
        ...
        G_reconstructed = self.reconstructed_history[frame]
        ...
        # Right: Target Graph
        G_target = self.target_graphs[frame // self.num_graphs]
